...
class DebugApi(object):
    ...
    def log_debug_info(self, **kwargs):  # noqa: E501
        """Log Debug Info  # noqa: E501

        Trigger debugging info to be logged.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.log_debug_info(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.log_debug_info_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.log_debug_info_with_http_info(**kwargs)  # noqa: E501
            return data

    def log_debug_info_with_http_info(self, **kwargs):  # noqa: E501
        """Log Debug Info  # noqa: E501

        Trigger debugging info to be logged.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.log_debug_info_with_http_info(async_req=True)
        >>> result = thread.get()
